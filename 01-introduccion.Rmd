...
- Se deben verificar empíricamente los supuestos del modelo para que la inferencia goce de validez.
...
Si se seleccionan diferentes muestras de una población, entonces el valor de un estadístico cambia dependiendo de la muestra seleccionada.
...
¿Por qué $\bar{X}$ "mejora" como estimador de $\mu$ cuando aumenta el tamaño muestral?
